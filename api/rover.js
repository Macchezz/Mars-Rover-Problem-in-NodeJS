function Rover(x, y, direction) {
    this.x = x; //x position of the rover
    this.y = y; //y position of the rover
    this.direction = direction; //rover direction
    ...
    this.get_x_coord = function() {
        return this.x;
    }

    this.get_y_coord = function() {
        return this.y;
    }
    ...
    this.move = function(towards, surface) { //function that moves the rover, inputs: surface and towards(F or B)
        try {
    ...
    this.turn = function(turn) { //function that turns the rover to the passed direction
        try {
    ...
    this.queue = function(commands, surface) {// function that queues the commands passed through the array
        try {
