function Planet(cells) {
    ...
    *1 -> the obstacle
    */
    this.init = function(x, y) {//surface initialization, randomly insterting terrain and obstacles, then the cell of the rover is set to 0, because it can't be an obstacle
        try {
